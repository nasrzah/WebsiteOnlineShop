...
<body>
      ...
      <div class="swiper home-slider">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide slide">
            <div class="image">
              <img src="images/PRODUK_HNI.png" alt="">
            </div>
            <div class="content">
          ...
          <div class="swiper-slide slide">
            <div class="image">
              <img src="images/PRODUK_VARASH.png" alt="">
            </div>
            <div class="content">
              <span>Diskon Hingga 40%</span>
              <h3>Product Varash</h3>
              <a href="shop.php" class="btn">Belanja</a>
            </div>
          </div>
    ...
    <div class="swiper category-slider">
      ...
      <div class="swiper-wrapper">
        ...
        <a href="category.php?category=laptop" class="swiper-slide slide">
          <img src="images/logo HNI.png" alt="">
          <h3>HNI</h3>
        </a>
  ...
  <section class="products">
    ...
    <h1 class="heading"><span>Rekomendasi Produk</span></h1>
  ...
  <section class="home-contact">
    <div class="content">
      <h3>Ingin Menjadi Agen?</h3>
      <p>
        Anda dapat menjadi agen penjualan Varash dan HNI bersama kami 
      dan dapatkan segala keuntungan dengan menjadi agen.
      </p>
